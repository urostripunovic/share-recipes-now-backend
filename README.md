...
## TODO
- [ ] Once it's done deploy it to vercel with [Hono's tutorial](https://hono.dev/getting-started/vercel)
- [ ] Try creating the recipe page in the backend with [Hono html helper](https://hono.dev/helpers/html) and [HTMX](https://htmx.org/)
- [ ] Rebuild the database and insert ingredients into it.
    - Scrap a website for a bunch of ingredients, save it as a json file and run it once when a fresh db is added
